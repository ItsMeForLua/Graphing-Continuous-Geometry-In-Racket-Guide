...
\title{Directed Dimensions: Basic and Fundamental Transformations in n-dimensional Space}
...
\begin{document}
	...
	\todo[inline color=blue!20 size=\small]{Here I might explain that the variables y and x in this context represent infinite number of points on a circle's boundary. They do not necessarily represent any particular single number.}
	...
	\subsection{Parametric Transformation of Representation}
	...
	\todo[inline color=blue!20 size=\small]{I need to change those | symbols; I already defined a vecnorm macro with FootnotesMacros.}
	\begin{equation*}
		\begin{split}
	...
	\todo[inline color=blue!20 size=\small]{I'm thinking that this section should actually be specifically about Racket and Lambda Calculus, and should additionally be moved up. Maybe it should instead be the first section. Otherwise, it may just get buried, and right now it just seems randomly placed.}
	...
	\subsection{Graphing a Standard Circle in \iRac}
