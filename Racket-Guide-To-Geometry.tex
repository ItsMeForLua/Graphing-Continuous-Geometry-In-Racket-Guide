...
\begin{document}
	...
	\end{equation*}
	This explains the definition of a circle, but now let us present a predicament in which we are given the equation \(x^2 + y^2 = 4\), and are tasked with plotting our circle in \iRac. One might be tempted to simply set the radius to 4; however, the true radius of this circle is 2. One may wonder how we arrived at this value--do the exponents of \(x\) and \(y\) denote the radius of the circle, or did we take the square root? Remember that we established the radius \Lr is equal to the magnitude:
	\begin{equation*}
...
\begin{comment}
	\begin{figure}[H]
		\centering
		\includegraphics[width=0.4\textwidth]{para_circle.png}
		\caption{}
		\label{fig:overlap}
	\end{figure}
\end{comment}
